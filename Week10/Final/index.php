...
<h1>Account Sign Up</h1>
    <body>
       <!if $errors set then echo $error messages>  
        <?php 
...
<input type="radio" name="heard_from" value="Search Engine" <?php if(isset($heard_from)&&($heard_from ==="Search Engine")){echo 'checked="checked"';} ?> />
Search engine<br />
<input type="radio" name="heard_from" value="Friend" <?php if(isset($heard_from)&&($heard_from ==="Friend")){echo 'checked="checked"';} ?> />
Word of mouth<br />
<input type=radio name="heard_from" value="Other" <?php if(isset($heard_from)&&($heard_from ==="Other")){echo 'checked="checked"';} ?> />
Other<br />
<p>Contact via:</p>
