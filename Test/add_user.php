...
<html>
    ...
    <body>
        ...
        if(empty($name)){
            $error_message .= '<p>enter a name</p>';
        } if(empty($_POST['phone'])){
             $error_message .= '<p>enter a phone</p>';
        } if(empty($_POST['email'])){
             $error_message .= '<p>enter a email</p>';
        }  if(empty($_POST['zip'])){
             $error_message .= '<p>enter a zip</p>';
        } if(!is_numeric($phone)){
            $error_message .= '<p>enter numbers only for your phone</p>';
        } if(!is_numeric($zip)){
            $error_message .= '<p>enter numbers only for your zipcode</p>';
        }
